      ...
      <div className="container ">
        ...
        <div className="grid justify-between gap-4 p-6 border-2 rounded-[10px] sm:grid-cols-1 md:grid-cols-2 border-secondary">
          <div className="m-auto">
            <img src={logo} alt="" />
            <p className="py-4 md:text-3xl text-xl text-gray-600">Join a growing network of professionals and job seekers who are here to support each other on their journey to success.</p>
            <button className="relative md:text-lg text-sm z-10  py-2 overflow-hidden font-bold text-white border-2 rounded-md md:px-8 px-2 isolation-auto border-secondary before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-right-full before:hover:right-0 before:rounded-full before:bg-white before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 hover:text-secondary bg-secondary">Be Part of the Q-Prep Community</button>
