...
function Works() {
  return (
    ...
    How it <span className="text-transparent bg-gradient-to-r from-primary via-slate-500 to-secondary bg-clip-text">works</span>
    </h1>
          ...
          <p className="mb-4 ml-5 text-xl font-semibold text-gray-900">
          Complete a quick test to determine your expertise level (Beginner, Intermediate, or Advanced)           <Link className="text-lg underline text-primary">Read more</Link>

          </p>
        </div>
        <div className="w-full md:w-[30%] flex justify-center mb-6 md:mb-0">
          <img src={home_works} alt="About Q-Prep" className="" />
        </div>
      </div>
    </div>
  );
