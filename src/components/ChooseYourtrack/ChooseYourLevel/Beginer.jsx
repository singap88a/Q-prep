...
function Beginer({ savedQuestions, setSavedQuestions }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://questionprep.azurewebsites.net/api/Questions/Q_BeginnerLevel/${frameworkId}`);
        ...
        <div className="container">
            <div className="flex justify-between">
                <div className="flex items-center justify-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold">{BeginQuestions[0]?.frameworkName}</h1>
