        ...
        currentCards.map((item) => {
          ...
          return (
            <div
              ...
              className={`flex flex-col sm:flex-row items-center justify-between p-4 mb-6 bg-[#8349DB0D] rounded-lg shadow-md transition ${isJoined ? "cursor-pointer hover:bg-[#8349DB1A]" : ""
                }`}
            >
              ...
              <div className="flex items-center mt-4 space-x-3 sm:mt-0">
                ...
                <button
                  className={`px-4 py-1 text-sm rounded-full transition min-w-[60px] relative ${isJoined
      ...
      {filteredData.length > cardsPerPage && (
        <div className="flex justify-center mt-6 mb-20">
          ...
          {Array.from({ length: totalPages }, (_, index) => (
            <button
              key={index}
              className={`px-4 py-2 mx-1 rounded-lg ${currentPage === index
